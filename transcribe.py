...
apikey = "fgGwj0PPTo8xciIOxiNaw8evUBztLbpk15BI_3Of2B8t"
url = "https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/f3357c0f-ffdb-45ec-9d84-cfc16a6f92dd"
#setup service
...
authenticator = IAMAuthenticator('6lYiiNF8E7YfHT9ZGbLusYFjiMMQ1AahVZE5nT9T4i1F')
assistant = AssistantV2(
version='2021-07-29',
authenticator=authenticator
)
assistant.set_service_url('https://api.eu-de.assistant.watson.cloud.ibm.com/instances/3b741d49-67d0-40e1-8df0-c36e3787512b')
...
def read_audio(ws, timeout):
    ...
    assistant_id='1839c353-8864-4837-9e1b-6c005d7c3838',
    input={
        'message_type': 'text',
        'text': txt
    }
